...
**Goal:** Add 7 skills to claude-superskills covering the full GTM cycle for Microsoft consulting — from ICP to co-sell, from qualification to account expansion. Fills a gap not covered by `abx-strategy`, `product-strategy`, or `startup-growth-strategist`.
...
## Session Context (as of 2026-04-03)
...
- ⏳ Batch 2 awaiting Batch 1 complete + review
...
### Skill Usage Flow (how Eric would use this daily)
...
**Initial assessment (no full triage yet):**
...
- Triage of these repos should happen in a separate session, following the `obsidian-skills-adoption-plan.md` process as a model

### Design Decisions Fixed (do not revert)
...
5. **Framework source:** the 21 frameworks are used as adapted ingredients for the Avanade context, not copied verbatim
...
> **Hero Offer rule:** Hero Offers (fixed-fee, $30–75K, 2–6 weeks) are **the recommended entry option for Whitespace and Emerging**, not a mandatory gate. The client can buy SI directly if the context allows. The important thing is to sell.
...
**Why not `abx-strategy`?** `abx-strategy` targets generic B2B with <500 accounts and SaaS. This skill is specific to: Microsoft platform consulting, Avanade/Microsoft ecosystem dynamics, MVC/HG/Emerging/Whitespace segmentation, and differences in the buyer committee between a CIO buying an Assessment vs. a CFO approving a 3-year Outsourcing engagement.
...
2. "Score this account for Outsourcing: High Growth, CMT sector, $2M potential, recently changed CFO, LGPD mandatory"
...
**Purpose:** Build GTM strategy for Microsoft platform consulting offers targeting Avanade's account tiers. Produces GTM canvas per offer type with value prop by pillar, entry motion, expansion arc, and win metrics.
...
- "Our win-rate is low — help review the qualification criteria"
- "MEDDPICC completo para esta oportunidade de SI de $800K"
- "Define kill conditions for this deal — we've had 3 months with no progress"

**Content specification:**

Phase 1: BANT Consultivo (DDC SAL Qualification)
- Budget: confirmed budget or expected approval (right question: "What is the budget approval process for this project?")
- Authority: economic buyer identified and accessible (right question: "Who signs the contract? Have we already spoken with this person?")
...
- "What is the go/no-go decision for continuing to invest pre-sales in Cielo?"
- "Identify kill signals in this deal — we've had 5 months of stall"
- "How do I structure pursuit governance for opportunities above $500K?"
- "The client is stuck and won't decide — how do I apply JOLT in this situation?"
...
- "Prepare discovery questions for a CFO who is evaluating Outsourcing"
...
**Purpose:** Co-selling strategy with Microsoft for Avanade accounts. Maps ATU/STU/CSU roles, evaluates co-sell readiness, defines engagement strategy by offer, and identifies access to funding/incentives (MACC, Solution Play funding, FastTrack, ADS).
...
- "Build co-selling strategy with STU for a $800K Cloud Migration deal"
...
**Trigger phrases:**
- "Build the expansion strategy for Bradesco — we're already an SI supplier"
