...
Automated workflow that publishes the `claude-superskills` package to npm when you create a version tag.
...
- ✅ When finished, package is on npm!
...
- ✅ **No local 2FA**: Token is secure on GitHub
...
- Create new token and update the secret
...
# Check at: https://github.com/ericgandrade/claude-superskills/actions
```
